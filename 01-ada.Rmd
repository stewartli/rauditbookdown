...
- Chapter 6 looks at the various utility tools which would not fit elsewhere in the book, and yet be important enough to mention.    

This book is ~~to be published by Chapman & Hall/CRC Press in 2022. Its online version is free to read thanks to the publisher, and~~ licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. If you acknowledge the source and use the contents or any examples of this book for teaching purposes, you don’t need to ask the permission to do so.
