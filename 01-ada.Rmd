...
This book is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. The code contained in this book is available under the MIT license. If you acknowledge the source and use the contents or any examples of this book for teaching purposes, you don’t need to ask the permission to do so.
